...
window.AWSClient = function(editorUi, authName)
{
	DrawioClient.call(this, editorUi, authName || 'ghauth');
};

// Extends DrawioClient
mxUtils.extend(AWSClient, DrawioClient);
 ...
 */
AWSClient.prototype.clientId = (window.location.hostname == 'test.draw.io') ? 'Iv1.1218f5567fbc258a' : window.DRAWIO_GITHUB_ID;

/**
 * Default extension for new files.
 */
AWSClient.prototype.extension = '.drawio';

/**
 * Base URL for API calls.
 */
AWSClient.prototype.baseUrl = DRAWIO_GITHUB_API_URL;
 ...
 */
AWSClient.prototype.maxFileSize = 1000000 /*1MB*/;

/**
 * Name for the auth token header.
 */
AWSClient.prototype.authToken = 'token';

AWSClient.prototype.setToken = function(token)
{
	_token = token;	
};
 ...
 */
AWSClient.prototype.updateUser = function(success, error, failOnAuth)
{
 ...
 * Authorizes the client, gets the userId and calls <open>.
 */
AWSClient.prototype.createUser = function(userInfo)
{
 ...
 * Authorizes the client, gets the userId and calls <open>.
 */
AWSClient.prototype.authenticate = function(success, error)
{
...
AWSClient.prototype.authenticateStep2 = function(state, success, error)
{
 ...
 * Authorizes the client, gets the userId and calls <open>.
 */
AWSClient.prototype.getErrorMessage = function(req, defaultText)
{
	try
	{
 ...
 * Authorizes the client, gets the userId and calls <open>.
 */
AWSClient.prototype.showAuthorizeDialog = function(retryFn, cancelFn)
{
 ...
 * Authorizes the client, gets the userId and calls <open>.
 */
AWSClient.prototype.executeRequest = function(req, success, error, ignoreNotFound, returnNotFound)
{
 ...
 */
AWSClient.prototype.getLibrary = function(path, success, error)
{
 ...
 * Checks if the client is authorized and calls the next step.
 */
AWSClient.prototype.getSha = function(org, repo, path, ref, success, error, returnNotFound)
{
 ...
 * Checks if the client is authorized and calls the next step.
 */
AWSClient.prototype.getFile = function(path, success, error, asLibrary, checkExists)
{
 ...
 */
AWSClient.prototype.createGitHubFile = function(org, repo, ref, data, asLibrary)
{
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
AWSClient.prototype.insertLibrary = function(filename, data, success, error, folderId)
{
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
AWSClient.prototype.insertFile = function(filename, data, success, error, asLibrary, folderId, base64Encoded)
{
	asLibrary = (asLibrary != null) ? asLibrary : false;
 ...
 * 
 */
AWSClient.prototype.showCommitDialog = function(filename, isNew, success, cancel)
{
 ...
 * 
 */
AWSClient.prototype.writeFile = function(org, repo, ref, path, message, data, sha, success, error)
{
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
AWSClient.prototype.checkExists = function(path, askReplace, fn)
{
	var tokens = path.split('/');
	var org = tokens[0];
	var repo = tokens[1];
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
AWSClient.prototype.saveFile = function(file, success, error, overwrite, message)
{
 ...
 * Checks if the client is authorized and calls the next step.
 */
AWSClient.prototype.pickLibrary = function(fn)
{
	this.pickFile(fn);
};
 ...
 * Checks if the client is authorized and calls the next step.
 */
AWSClient.prototype.pickFolder = function(fn)
{
 ...
 * Checks if the client is authorized and calls the next step.
 */
AWSClient.prototype.pickFile = function(fn)
{
 ...
 * 
 */
AWSClient.prototype.showGitHubDialog = function(showFiles, fn)
{
	var org = null;
	var repo = null;
	var ref = null;
 ...
 * Checks if the client is authorized and calls the next step.
 */
AWSClient.prototype.logout = function()
{
